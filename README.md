...
1. [Introduction and Project Objective](https://www.google.com/search?q=%231-introduction-and-project-objective)
2. [Dataset and Asset Selection](https://www.google.com/search?q=%232-dataset-and-asset-selection)
3. [Walk-Forward Validation Methodology](https://www.google.com/search?q=%233-walk-forward-validation-methodology)
4. [Feature Engineering and Variable Pre-selection](https://www.google.com/search?q=%234-feature-engineering-and-variable-pre-selection)
* [Financial Data Standardization](https://www.google.com/search?q=%23financial-data-standardization)
* [Construction of Explanatory Variables](https://www.google.com/search?q=%23construction-of-explanatory-variables)
* [Rolling Z-Score Transformation for Fundamental Indicators](https://www.google.com/search?q=%23rolling-z-score-transformation-for-fundamental-indicators)
* [Multi-stage Feature Pre-selection Procedure](https://www.google.com/search?q=%23multi-stage-feature-pre-selection-procedure)


5. [Realistic Simulation Environment (StockTradingEnv)](https://www.google.com/search?q=%235-realistic-simulation-environment-stocktradingenv)
* [Proprietary Modifications (Adaptation to the XTB platform)](https://www.google.com/search?q=%23proprietary-modifications-adaptation-to-the-xtb-platform)
* [Logarithmic Reward Function](https://www.google.com/search?q=%23logarithmic-reward-function)


6. [Training Methodology and Hyperparameter Tuning](https://www.google.com/search?q=%236-training-methodology-and-hyperparameter-tuning)
* [Validation Criterion: Sortino Ratio](https://www.google.com/search?q=%23validation-criterion-sortino-ratio)
* [Bayesian Optimization (TPE in Optuna) with Seed Variance Control](https://www.google.com/search?q=%23bayesian-optimization-tpe-in-optuna-with-seed-variance-control)


7. [Stochasticity Management: Multi-agent Ensembles (Ensemble Learning)](https://www.google.com/search?q=%237-stochasticity-management-multi-agent-ensembles-ensemble-learning)
* [Statistical Rationale](https://www.google.com/search?q=%23statistical-rationale)
* [Signal Aggregation Variants](https://www.google.com/search?q=%23signal-aggregation-variants)
* [Signal Stability Analysis](https://www.google.com/search?q=%23signal-stability-analysis)


8. [Research Results and Key Findings](https://www.google.com/search?q=%238-research-results-and-key-findings)
* [Reference Strategy (Benchmark) Results](https://www.google.com/search?q=%23reference-strategy-benchmark-results)
* [Effectiveness of DRL Ensembles and Noise Filtering](https://www.google.com/search?q=%23effectiveness-of-drl-ensembles-and-noise-filtering)
* [Behavior Analysis during the Crash (Q1 2020) and the Rebound Bull Market](https://www.google.com/search?q=%23behavior-analysis-during-the-crash-q1-2020-and-the-rebound-bull-market)


9. [Future Work Directions](https://www.google.com/search?q=%239-future-work-directions)
...
2. **Hierarchical clustering:** Based on the distance matrix $1 - \vert{}\rho\vert{}$, variables were grouped using the hierarchical clustering algorithm with complete linkage. The dendrogram was cut at a distance threshold of **0.3**, guaranteeing that the rank correlation between all variables within a single cluster was at least **0.7** (the standard limit for critical multicollinearity). This method grouped 110 variables into approx. 39–40 clusters.
