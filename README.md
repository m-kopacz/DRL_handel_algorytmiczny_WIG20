...
#### Skumulowane stopy zwrotu składowych portfela w 2020 roku
...
#### Przesuwne okna czasowe w metodzie walidacji kroczącej
...
#### Proces klasteryzacji hierarchicznej zmiennych kandydujących na przykładzie okna czasowego z indeksem 1
...
#### Ranking istotności predykcyjnej wskaźników wyznaczony na podstawie uśrednienia wartości Shapleya dla okna czasowego z indeksem 1
...
#### Zestawienie wybranych zmiennych wraz z ich mocą predykcyjną w procesie preselekcji
...
#### Zróżnicowanie przebiegu krzywych kapitału w symulacji testowej bazującej na sygnałach pojedynczych agentów (100 przebiegów)
...
#### Wpływ liczebności komitetów (N) na odchylenia standardowe surowych sygnałów
...
#### Średnia bezwzględna zmiana surowych sygnałów (MAC) w zależności od liczebności komitetów (N)
...
#### Przebieg krzywych kapitału w czasie dla benchmarków
...
#### Zbieżność metryk jakości strategii inwestycyjnych względem rozmiaru komitetów (N)
...
#### Porównanie rozkładów gęstości uzyskanych metryk przez komitety o liczebności N = 1 oraz N = 50
...
#### Wpływ liczebności komitetów (N) na odsetek instancji przewyższających benchmark Buy&Hold oraz generujących dodatnią stopę zwrotu
...
#### Obszar przebiegu krzywych kapitału w 30 iteracjach komitetów o liczebności N = 50 na tle benchmarków
...
#### Dynamika zmian cen akcji spółek wchodzących w skład portfela w Q1 2020
...
#### Obszar przebiegu krzywych kapitału w 30 iteracjach komitetu o najwyższej medianie metryk jakości (liczebność N = 50) na tle benchmarków
